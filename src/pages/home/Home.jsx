...
<section className="py-16 bg-gray-100 text-center">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <p className="text-rose-600 font-semibold tracking-widest uppercase mb-2">We Work With</p>
    <h3 className="text-3xl md:text-4xl font-bold mb-10 text-gray-800">
      Our Published Books Have Been Covered By
    </h3>
    <div className="flex flex-wrap justify-center items-center gap-8 opacity-80">
      <img src="image_3471c5.png" alt="Partner Logos" className="max-h-20 w-auto object-contain" />
    </div>
  </div>
</section>
...
<section className="py-20 bg-[gradient-to-b] from-sky-950 to-sky-900 text-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <h2 className="text-4xl font-bold mb-16">
      We Take Every Project to Success with Our Professional & Affordable Services
    </h2>

    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {/* <!-- Reusable Service Card --> */}
      <div
        className="group bg-white text-gray-800 rounded-2xl p-6 border border-gray-200 shadow-md hover:shadow-xl hover:bg-sky-800 hover:text-white transition-all duration-300"
      >
        <svg
        ...
        <h3 className="font-semibold text-lg mb-2">Children’s Book Service</h3>
      ...
      >
        ...
        <h3 className="font-semibold text-lg mb-2">Ghost Writing Services</h3>
        <p className="text-sm opacity-80 group-hover:opacity-100">
...
<section className="bg-white py-20 px-6 sm:px-8 lg:px-24">
  <div className="max-w-5xl mx-auto text-center mb-12">
    ...
    <p className="text-lg text-gray-600">Learn About Our Professional Book Publishing Steps</p>
  </div>

  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    {/* <!-- Single Step --> */}
    <div className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1">
      <div className="w-12 h-12 bg-indigo-500 text-white rounded-full flex items-center justify-center font-bold mb-4">01</div>
      <h3 className="text-xl font-semibold mb-2 text-gray-800">Manuscript Finalization</h3>
      <p className="text-gray-600">We refine or create your manuscript for maximum impact.</p>
    </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    <div>
      ...
      <p className="text-gray-600 mb-4">
        Your book deserves global recognition — our marketing ensures it shines everywhere.
      </p>
      <p className="text-gray-600 mb-8">
        We don’t just help publish — we position your work for success. Let's give your book the audience it deserves.
      </p>
      <a
        href="#"
...
<section className="py-16 bg-sky-950 text-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
    <div>
      ...
      <p className="text-lg text-gray-200">We Promise the Success Your Book Deserves!</p>
    </div>
    <a
      href="#"
...
<section className="py-20 lg:py-24 bg-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <p className="text-rose-600 font-semibold tracking-widest uppercase mb-3">Our Portfolio</p>
    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
      Get a Sneak Peek of Our Work
    </h2>
    <p className="max-w-3xl mx-auto text-gray-600 mb-16 leading-relaxed">
      You’ll be amazed at how professionally we cater to our clients, delivering exactly what they need.
      Our expert team ensures a smooth and seamless publishing process.
    </p>
...
<section className="py-20 lg:py-24 bg-sky-950 text-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <p className="text-rose-500 font-semibold tracking-widest uppercase mb-2">Testimonials</p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-rose-600 text-gray-800">
        ...
        <p className="italic mb-6">
          “From editing to publishing, the process was smooth and stress-free.
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-rose-600 text-gray-800">
        <div className="text-2xl text-yellow-500 mb-4">★★★★★</div>
        <p className="italic mb-6">
          “They transformed my manuscript into a beautifully formatted eBook
          that looks amazing on every platform!”
        </p>
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-rose-600 text-gray-800">
        <div className="text-2xl text-yellow-500 mb-4">★★★★★</div>
        <p className="italic mb-6">
          “I had a story in mind but didn’t know where to start. Their team helped
          bring my vision to life effortlessly!”
        </p>
...
<section className="bg-white py-20 px-4 sm:px-6 lg:px-8">
  <div className="text-center max-w-3xl mx-auto mb-12">
    <p className="text-sm uppercase text-rose-600 tracking-widest mb-2">— Anything to Ask</p>
    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Frequently Asked Questions</h2>
    <p className="text-gray-500">
      Before contacting us, check whether your question is already answered below.
    </p>
  </div>
  ...
  <div className="max-w-3xl mx-auto divide-y divide-gray-200">
    ...
    <div className="flex justify-between items-center py-5 cursor-pointer hover:text-rose-600 transition">
      <span className="text-lg text-gray-800">How can I publish my book?</span>
      <span className="text-rose-600 text-xl font-bold">+</span>
    </div>
    <div className="flex justify-between items-center py-5 cursor-pointer hover:text-rose-600 transition">
      <span className="text-lg text-gray-800">How to publish a book on Amazon?</span>
      <span className="text-rose-600 text-xl font-bold">+</span>
    </div>
    <div className="flex justify-between items-center py-5 cursor-pointer hover:text-rose-600 transition">
      <span className="text-lg text-gray-800">How much does it cost to publish a book?</span>
      <span className="text-rose-600 text-xl font-bold">+</span>
    </div>
    <div className="flex justify-between items-center py-5 cursor-pointer hover:text-rose-600 transition">
      <span className="text-lg text-gray-800">How to get a publisher for a book?</span>
      <span className="text-rose-600 text-xl font-bold">+</span>
    </div>
    <div className="flex justify-between items-center py-5 cursor-pointer hover:text-rose-600 transition">
...
<section className="py-12 bg-sky-950">
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
    <h2 className="text-3xl sm:text-4xl font-bold mb-10">Our Achievements</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
      ...
      <div className="flex flex-col items-center bg-sky-900 p-6 rounded-xl shadow-lg hover:shadow-2xl transition">
        ...
        <div className="text-3xl font-extrabold counter" data-target="150">0</div>
        <p className="mt-2 font-semibold text-gray-300">Projects Completed</p>
      </div>
      ...
      <div className="flex flex-col items-center bg-sky-900 p-6 rounded-xl shadow-lg hover:shadow-2xl transition">
        ...
        <div className="text-3xl font-extrabold counter" data-target="120">0</div>
      ...
      <div className="flex flex-col items-center bg-sky-900 p-6 rounded-xl shadow-lg hover:shadow-2xl transition">
        ...
        <div className="text-3xl font-extrabold counter" data-target="200">0</div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div>
      ...
      <p className="text-lg text-gray-600 leading-relaxed">
        We’re here to give your book the recognition it deserves. Reach out to our expert team at
        <a
