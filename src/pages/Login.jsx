...
const Login = () => {
  ...
  const handleLogin = () => {
    authDispatch({ type: "LOGGED_IN", payload: email });
    navigate("/");
  };
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-900 font-sans p-4 mt-10 ">
        ...
        <div className="relative w-full max-w-md bg-gray-800 p-6 rounded-2xl shadow-lg shadow-cyan-500/20 border border-gray-500">
          <img
            className="w-40 mx-auto rounded-4xl p-2 text-white mb-4"
            src={Icons.Logo}
            alt="logo"
          />
          ...
          <form className="space-y-6">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute  inset-y-0 right-0 top-7 flex items-center pr-3 text-gray-400 hover:text-gray-200"
            ...
            <button
              type="button"
              className="w-full px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition duration-200 cursor-pointer"
              onClick={handleLogin}
            >
              Log In
            </button>
          ...
          <button className="w-full flex items-center justify-center px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg border border-gray-600 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition duration-200 cursor-pointer">
            {/* Google Logo SVG */}
            <svg
